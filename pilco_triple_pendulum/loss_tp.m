%% loss_tp.m
% *Summary:* Triple-Pendulum loss function; the loss is
...
%
%   cost            cost structure
%     .p            lengths of the 3 pendulums                      [3 x 1]
...
ell1 = cost.p(1); ell2 = cost.p(2); ell3 = cost.p(3); 
C = [ell1 0 ell2 0 ell3 0; 0 ell1 0 ell2 0 ell3];
Q = zeros(D1); Q(D0+1:D0+6,D0+1:D0+6) = C'*C;
