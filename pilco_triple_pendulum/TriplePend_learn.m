%% TriplePend_learn
% *Summary:* Script to learn a controller for the triple-pendulum
% swingup with three actuated joints
%
...
%clear all; 
close all;
settings_tp;                  % load scenario-specific settings
basename = 'triplepend_';     % filename used for saving data
